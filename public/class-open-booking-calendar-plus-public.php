 ...
 * @subpackage Open_Booking_Calendar_Plus/public
 */
 ...
 */
class Open_Booking_Calendar_Plus_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $open_booking_calendar_plus       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->open_booking_calendar_plus, plugin_dir_url( __FILE__ ) . 'css/open-booking-calendar-plus-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->open_booking_calendar_plus, plugin_dir_url( __FILE__ ) . 'js/open-booking-calendar-plus-public.js', array( 'jquery' ), $this->version, false );
